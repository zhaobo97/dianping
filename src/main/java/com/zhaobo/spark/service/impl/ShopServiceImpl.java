...
import com.zhaobo.spark.mapper.ShopModelMapper;
...
import com.zhaobo.spark.recommend.RecommendService;
import com.zhaobo.spark.recommend.RecommendSortService;
...
public class ShopServiceImpl implements ShopService {
    ...
    public List<ShopModel> recommend(BigDecimal longitude, BigDecimal latitude) {
        ...
        List<Integer> sorted = recommendSortService.sort(shopIdList, 148);
...
//        }
        ...
        jsonRequestObject.getJSONObject("query").getJSONObject("function_score")
       ...
       //4.1 查询相关性词性，分情况构建must节点下的数据
        ...
        if(cixingMap.isEmpty()){
            ...
            for(String key:cixingMap.keySet()){
                ...
                shouldTermObj.getJSONObject("term").getJSONObject("category_id").put("boost",0);
        ...
        if(orderBy == null){
            ...
            gauss.getJSONObject("gauss").getJSONObject("location").put("origin",
        ...
        jsonRequestObject.getJSONObject("aggs").getJSONObject("group_by_tags")
        ...
        JSONArray jsonArrayTags = jsonObject.getJSONObject("aggregations").getJSONObject("group_by_tags")
